/*
* OBTENIDA DE https://github.com/Arsenalist/Red-Black-Tree-Java-Implementation/blob/master/src/RedBlackTree.java
*/
...
public class RedBlackTree<Key extends Comparable<Key>, Value> implements BSTree<Key,Value>{
	...
	public RedBlackNode<Key, Value> root = nil;
	...
	private void leftRotate(RedBlackNode<Key, Value> x){
	...
	private void rightRotate(RedBlackNode<Key, Value> y){
	...
	private void insert(RedBlackNode<Key,Value> z) {

			// Create a reference to root & initialize a node to nil
			RedBlackNode<Key,Value> y = nil;
			RedBlackNode<Key,Value> x = root;
	...
	private void insertFixup(RedBlackNode<Key,Value> z){
	...
	public RedBlackNode<Key,Value> treeMinimum(RedBlackNode<Key,Value> node){
	...
	// from x.key
	public RedBlackNode<Key,Value> treeSuccessor(RedBlackNode<Key,Value> x){
		...
		RedBlackNode<Key,Value> y = x.parent;
	...
	public void remove(RedBlackNode<Key,Value> v){

		RedBlackNode<Key,Value> z = search(v.key);

		// Declare variables
		RedBlackNode<Key,Value> x = nil;
		RedBlackNode<Key,Value> y = nil;
	...
	private void fixNodeData(RedBlackNode<Key,Value> x, RedBlackNode<Key,Value> y){

		// Initialize two variables which will help us traverse the tree
		RedBlackNode<Key,Value> current = nil;
		RedBlackNode<Key,Value> track = nil;
	...
	private void removeFixup(RedBlackNode<Key,Value> x){

		RedBlackNode<Key,Value> w;
    ...
    public void display(RedBlackNode<Key,Value> root){
        if(!isNil(root)){
            display(root.left);
	...
	public int findNumGreater(RedBlackNode<Key,Value> node, Key key){
     ...
     */
    public List<Key> getGreaterThan(Key key, Integer maxReturned) {
    ...
    private void getGreaterThan(RedBlackNode<Key,Value> node, Key key,
                                List<Key> list) {
        if (isNil(node)) {
            return;
	...
	public int findNumSmaller(RedBlackNode<Key,Value> node, Key key){
