...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        SplayBST<String, String> dicSP  = new SplayBST<String, String>();
        RedBlackTree<String, String> dicRBT = new RedBlackTree<String, String>();
        ...
        if(opcion.equals("1")){ //Se utiliza SPLAY TREE
            ...
            dicSP.display(dicSP.root);


        }
        
        else if(opcion.equals("2")){ //Se utiliza RED BLACK TREE
